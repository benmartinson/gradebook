...
const GradebookPage = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <main className="min-h-[650px] h-[100vh] bg-gradient-to-br from-indigo-50 to-blue-100 sm:p-5">
      <div className="bg-white sm:rounded-xl shadow-lg flex-1 w-full h-full mx-auto flex flex-col sm:flex-row overflow-hidden">
